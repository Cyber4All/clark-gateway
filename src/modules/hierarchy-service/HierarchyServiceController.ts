...
const HIERARCHY_API = process.env.HIERARCHY_API || "10.128.178.17:6000";
...
export class HierarchyServiceController implements Controller {
    buildRouter(): Router {
         ...
         */
        router.patch("/learning-objects/:id/status", this.proxyRequest((req: Request) => LEARNING_OBJECT_ROUTES.CHANGE_HIERARCHY_STATUS(req.params.id)));
